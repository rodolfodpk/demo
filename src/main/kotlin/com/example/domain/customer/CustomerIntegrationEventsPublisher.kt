...
@Singleton
class CustomerIntegrationEventsPublisher(private val nats: StreamingConnection)
    : JsonEventPublisher {

    companion object {
        private val log = LoggerFactory.getLogger(CustomerIntegrationEventsPublisher::class.java)
    }
